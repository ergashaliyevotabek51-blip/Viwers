...
# Majburiy obuna kanali (None bo'lsa majburiy obuna yo'q)
...
# ================= SETTINGS (majburiy kanal saqlash) =================
def load_settings():
...
# Bot ishga tushganda bir marta yuklaymiz
load_settings()
...
# ================= START (majburiy obuna tekshiruvi qo'shildi) =================
...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Majburiy obuna tekshiruvi (kino kodi yuborilganda ham)
    if text in load_movies() and MANDATORY_CHANNEL and not await is_subscribed(context, user_id):
...
def main():
    ...
    # Alohida handlerlar – xavfsiz variant
